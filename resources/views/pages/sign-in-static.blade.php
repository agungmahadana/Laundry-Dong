...
@section('content')
    ...
    <main class="main-content border overflow-hidden">
        <section>
                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                ...
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Attention is the new currency {{-- WISH WASH --}}"</h4>
                                <p class="text-white position-relative">The more effortless the writing looks, the more effort the writer actually put into the process. {{-- We wish you wash here. --}}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
@php
    $class = isset($class) ? $class.'overflow-hidden' : 'overflow-hidden';
@endphp
