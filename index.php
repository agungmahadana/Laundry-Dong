...
<body>
    <div class="container h-100">
        <div class="row justify-content-center align-items-center h-100">
            <div class="col-lg-6 d-flex flex-column h-50 position-absolute top-0 justify-content-center">
                <h1 class="fw-bold text-white text-center">Laundry Dong</h1>
                <p class="lead text-white text-center">Semakin terlihat mudah membersihkan, semakin banyak tenaga yang sebenarnya dikeluarkan oleh pencuci.</p>
            </div>
            <div class="z-1 col-lg-5 d-flex flex-column gap-3 justify-content-center">
                <div class="bg-primary p-4 rounded d-flex flex-column gap-2 shadow-lg text-white">
                    <div>Masukkan kode transaksi 👇</div>
                    <form action="nota.php" method="get">
                        <input type="text" class="form-control bg-primary rounded" id="exampleFormControlInput1" name="kode" style="color: white;" onkeydown="if (event.keyCode === 13) this.form.submit();">
                    </form>
                </div>
            </div>
            <div class="border col-10 d-flex flex-column h-50 position-absolute bottom-0 justify-content-end">
                ...
                <div class="row justify-content-center mt-4 mb-4">
                    <div class="col-lg-2 d-flex col-md-6 justify-content-between">
